        ...
        for (int x = 0; x < SHAPE_DISPLAY_SIZE_X; x++) {
            ...
            for (int y = 0; y < SHAPE_DISPLAY_SIZE_Y; y++) {
                ...
                if (m_transformStartHeight >0){
                    if ((liveZonesPix[flattenedIndex] <= m_transformStartHeight +9) && ((liveZonesPix[flattenedIndex] >= m_transformStartHeight -9))){
                        heightsForShapeDisplay[flattenedIndex] = 0;
                    }if(liveZonesPix[flattenedIndex] >m_transformStartHeight +9){
                ...
                tempSum = tempSum+ (float)liveZonesPix[flattenedIndex];
